...
const bannerValidation = Joi.object({
    banner_url: Joi.string()
        ...
        .required()
        .messages({
            'string.empty': messageErrorBanner().banner_url.empty,
            'string.uri': messageErrorBanner().banner_url.invalid,
            'string.max': messageErrorBanner().banner_url.max(255),
            'any.required': messageErrorBanner().banner_url.required,
        }),
    title: Joi.string()
        .max(255)
        .required()
